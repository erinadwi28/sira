			...
			<div class="col-md-12 mb-4">
				...
				<div class="card shadow mb-4">
					<div class="card-body">
						...
						<form role="form" action="<?= base_url('kades/aksi_tambah_admin') ?>" method="post" id="formTambah" name="formTambah">
							...
							<div class="row">
								<div class="col-md-4">
                                    ...
                                    <div class="form-group">
										...
										<input type="text" class="form-control form-user-input" placeholder="masukan NIK di sini" name="nip" id="nip">
										<i class="fas fa-check-circle"></i>
										<i class="fas fa-exclamation-circle"></i>
										<small>Error Message</small>
									</div>
								...
								<div class="col-md-4">
                                    ...
                                    <div class="form-group">
										<label class="label-control" for="no_kk"><b>Jabatan</b></label>
										<input type="text" class="form-control form-user-input" placeholder="masukan jabatan di sini" name="jabatan" id="jabatan">
										<i class="fas fa-check-circle"></i>
										<i class="fas fa-exclamation-circle"></i>
										<small>Error Message</small>
									</div>
