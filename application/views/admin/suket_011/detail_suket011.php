...
<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Detail Data Permohonan</h1>
					</div>
					...
					<div class="row">
									...
									<form action="">
										<div class="row">
											<div class="col-md-12">
												...
												<center> <label for="nomor_surat_rt">No Surat Terakhir :
														XX/XX/XX/XXXX</label>
												</center>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-6 mb-3">
												<input type="text" class="form-control form-user-input"
													name="nomor_surat_rt" id="nomor_surat_rt">
											</div>
											<div class="col-md-3">
									...
									<table class="table-hover table-responsive">
										<tbody>
											...
											<tr>
												...
												<td> </td>
												<td> </td>
												<td>Nomor : 206 / KM / AS / VIII / 2020. Um</td>
											</tr>
											<tr>
						...
						<div class="col-md-4 mb-4">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<div class="mb-2">
										<img src="img/user1.png" alt="Pas foto" class="img-fluid">
									</div>
									<div class="mb-2">
										<img src="img/user1.png" alt="foto KK" class="img-fluid">
									</div>
									<div class="mb-2">
										<img src="img/user1.png" alt="foto Surat Pindah" class="img-fluid">
									</div>
								</div>
							</div>
						</div>
