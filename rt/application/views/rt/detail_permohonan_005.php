	...
	<div class="row">
		<div class="col-md-8 mb-4">
			...
			<div class="card shadow mb-2">
				...
				<div class="card-body">
					<form role="form" action="<?= base_url('rt/aksi_setujui_permohonan_005') ?>" method="post"
						id="suket005">
						<em class="small text-danger">*Pastikan data benar dan Isikan Nomor
							Surat Ketua RT</em>
						<div class="row">
							<div class="col-md-12">
								<center> <b><label for="nomor_surat_rt">Masukkan Nomor Surat
											Ketua RT Untuk
											Menyetujui</label></b>
								</center>
							</div>
						...
						<table class="table-hover table-responsive">
							<tbody>
								...
								<tr>
									...
									<td> </td>
									<td> </td>
									<td><?= format_indo(date($detail->tanggal_kegiatan)); ?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td> </td>
									<td> </td>
									<td><?= format_indo(date($detail->tgl_permohonan_surat)); ?>
									</td>
								</tr>
							</tbody>
						</table>
		...
		<div class="card shadow mb-2">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary text-center">SURAT IZIN KERAMAIAN
				</h6>
			</div>
			<div class="card-body">
				<form action="">
					<div class="row">
						<div class="col-md-12">
							<center> <b><label for="nomor_surat_admin">Nomor Surat
										Kelurahan</label></b>
							</center>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<input type="text" class="form-control form-user-input" name="nomor_surat_admin"
								...
								value="<?= $detail->no_tupoksi; ?>/<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_kecamatan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_tahun; ?>"
					...
					<div class="row">
						<div class="col-md-12">
							<center> <b><label for="nomor_surat_rt">Nomor Surat Ketua
										RT</label></b>
							</center>
						</div>
					</div>
	...
	<div class="col-md-4 mb-4">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body" style="padding: 15px;">
				<center>
					<div class="mb-2">
						<a href="<?= base_url(); ?>../assets/uploads/warga/suket_005/<?= $detail->foto_ktp; ?>"
							data-gallery="mygallery" data-title="Foto KTP" data-toggle="lightbox">
							<img src="<?= base_url(); ?>../assets/uploads/warga/suket_005/<?= $detail->foto_ktp; ?>"
