...
class Admin extends CI_Controller
{
        ...
        //tampil form cari nik ubah password _warga
        ...
        //aksi cari nik ubah password warga
        public function aksi_cari_nik_ubah_kata_sandi_warga()
        {
                ...
                $nik_warga = $this->input->post('nik');
                $detailhere = array('nik' => $nik_warga);
                $data_detail['detail_warga'] = $this->m_admin->get_detail_warga_ubah_kata_sandi($detailhere, 'warga')->result();

                if ($this->m_admin->get_detail_warga_ubah_kata_sandi($detailhere, 'warga')) {
                        // $this->session->set_flashdata('success', 'Data Berhasil Ditemukan');
