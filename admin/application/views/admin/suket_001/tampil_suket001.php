						...
						<div class="col-md-8">
							<div class="card shadow mb-4">
									...
									<center>
										...
										?>
											...
											<div class="badan_surat">
												<div class="no_surat">
													<center>
														<p><u>SURAT KETERANGAN USAHA</u><br>
															Nomor : <?= $w->no_registrasi; ?> / <?= $w->no_kelurahan; ?> / <?= $w->no_kecamatan; ?> / <?= $bulan; ?> / <?= $w->no_tahun; ?>. Um</p>
													</center>
												</div>
												...
												<div class="isi_surat paragraf">
													<p>
														Berdasarkan Surat Keterangan dari Ketua Rukun Tetangga ( RT ) <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?>
														Kelurahan Mendawai, tanggal<?php foreach ($detail_suket as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?>
													Nomor : <?= $w->nomor_surat_rt; ?>, bahwa yang bersangkutan
													memang benar penduduk RT. <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?> Kelurahan
													...
													<p>
														...
														dipergunakan sebagaimana mestinya. Dengan catatan
								...
								<div class="card-footer">
									<center>
										<a href="<?= base_url() ?>admin/cetak_surat/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
