						...
						<div class="col-md-8">
							<div class="card shadow mb-4">
											...
											<div class="badan_surat">
												...
												<div class="isi_surat paragraf">
													<p> Yang bertanda tangan dibawah ini, berdasarkan Surat Keterangan dari Ketua Rukun
														Tetangga
														( RT ) <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?>, Nomor : <?= $w->nomor_surat_rt; ?>, tanggal <?php foreach ($detail_suket as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?> menerangkan
															bahwa :</p>
												</div>
								...
								<div class="card-footer">
									<center>
										<a href="<?= base_url() ?>admin/cetak_surat009/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
