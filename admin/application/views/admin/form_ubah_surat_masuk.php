...
<div class="container-fluid">
	<!-- Page Heading -->
	<?php foreach ($detail_surat_masuk as $detail) {?>
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Ubah Data Surat Masuk</h1>
		<a href="<?= base_url()?>admin/detail_surat_masuk/<?= $detail->id_sm ?>">
		...
		<div class="col-md-8 mb-4">
			...
			<div class="card shadow mb-4">
				<div class="card-body">
					...
					<form role="form" action="<?= base_url('admin/aksi_ubah_surat_masuk') ?>" method="post"
						id="ubahSuratMasuk">
