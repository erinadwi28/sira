		...
		<div class="col-xs-12 col-sm-8">
			<div class="card shadow mb-5">
				<div class="body">
					...
					<form class="form-horizontal" id="form_ubah_suket010" action="<?= base_url('warga/aksi_ubah_suket010') ?>" method="POST">
						<div class="form-group">
								...
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="nama_anak" name="nama_anak" placeholder="masukkan nama anak disini..." value="<?= $detail->nama_anak; ?>">
							...
							<div class="form-group row" style="margin-left: 10px;">
								...
								<div class="col-sm-8">
									<div class="form-line focused">
										<input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Isikan tempat lahir anak..." value="<?= $detail->tempat_lahir; ?>">
										<i class=" fas fa-check-circle"></i>
										<i class="fas fa-exclamation-circle"></i>
										<small>Error massage</small>
									</div>
						...
						<div class="form-group">
							<div class="form-group" style="margin-top: 20px;">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="jam_lahir" name="jam_lahir" placeholder="Isikan jam lahir anak..." value="<?= $detail->jam_lahir; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
									...
									<div class="col-sm-8">
										<div class="form-line">
											<select class="form-control" id="kelahiran" name="kelahiran">
												...
												<option value="Tunggal" <?= ($detail->kelahiran == 'Tunggal' ? ' selected' : ''); ?> class="form-user-input">Tunggal
												</option>
												<option value="Kembar" <?= ($detail->kelahiran == 'Kembar' ? ' selected' : ''); ?> class="form-user-input">Kembar
												</option>
											</select>
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
									...
									<div class="col-sm-8">
										<div class="form-line">
											<select class="form-control" id="kembar_ke" name="kembar_ke">
												...
												<option value="1" <?= ($detail->kembar_ke == '1' ? ' selected' : ''); ?> class="form-user-input">1 </option>
												<option value="2" <?= ($detail->kembar_ke == '2' ? ' selected' : ''); ?> class="form-user-input">2 </option>
												<option value="3" <?= ($detail->kembar_ke == '3' ? ' selected' : ''); ?> class="form-user-input">3 </option>
												<option value="4" <?= ($detail->kembar_ke == '4' ? ' selected' : ''); ?> class="form-user-input">4 </option>
												<option value="5" <?= ($detail->kembar_ke == '5' ? ' selected' : ''); ?> class="form-user-input">5 </option>
												<option value="Tidak ada" <?= ($detail->kembar_ke == 'Tidak ada' ? ' selected' : ''); ?> class="form-user-input">Tidak ada </option>
											</select>
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										...
										<div class="form-line">
											<select class="form-control" id="tempat_persalinan" name="tempat_persalinan">
												<option value="pilih tempat bersalin..." class="form-user-input">pilih tempat
													bersalin...</option>
												<option value="Rumah Bersalin" <?= ($detail->tempat_persalinan == 'Rumah Bersalin' ? ' selected' : ''); ?> class="form-user-input"> Rumah Bersalin
												</option>
												<option value="Bukan Rumah Bersalin" <?= ($detail->tempat_persalinan == 'Bukan Rumah Bersalin' ? ' selected' : ''); ?> class="form-user-input">Bukan Rumah Bersalin
												</option>
											</select>
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<textarea class="form-control" id="alamat_persalinan" name="alamat_persalinan" rows="3" placeholder="masukkan alamat persalinan disini..."><?= $detail->alamat_persalinan; ?></textarea>
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
									...
									<div class="col-sm-8">
										<div class="form-line">
											<select class="form-control" id="penolong_persalinan" name="penolong_persalinan">
												...
												<option value="Dokter" <?= ($detail->penolong_persalinan == 'Dokter' ? ' selected' : ''); ?> class="form-user-input"> Dokter</option>
												<option value="Bidan/Perawat" <?= ($detail->penolong_persalinan == 'Bidan/Perawat' ? ' selected' : ''); ?> class="form-user-input"> Bidan/Perawat</option>
												<option value="Dukun" <?= ($detail->penolong_persalinan == 'Dukun' ? ' selected' : ''); ?> class="form-user-input"> Dukun</option>
												<option value="Lainnya" <?= ($detail->penolong_persalinan == 'Lainnya' ? ' selected' : ''); ?> class="form-user-input"> Lainnya</option>
							...
							<div class="form-group" style="margin-top: 15px;">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="nama_ibu" name="nama_ibu" placeholder="Isikan nama ibu..." value="<?= $detail->nama_ibu; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<textarea class="form-control" id="alamat_ibu" name="alamat_ibu" rows="3" placeholder="masukkan alamat disini..."><?= $detail->alamat_ibu; ?></textarea>
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<input type="date" class="form-control" id="tanggal_lahir_ibu" name="tanggal_lahir_ibu" value="<?= $detail->tanggal_lahir_ibu; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group">
								<div class="form-group" style="margin-top: 15px;">
									<div class="form-group row" style="margin-left: 10px;">
										...
										<div class="col-sm-8">
											<div class="form-line focused">
												<input type="number" class="form-control" id="umur_ibu" name="umur_ibu" placeholder="masukkan umur ibu disini..." value="<?= $detail->umur_ibu; ?>">
												<i class=" fas fa-check-circle"></i>
												<i class="fas fa-exclamation-circle"></i>
												<small>Error massage</small>
											</div>
							...
							<div class="form-group" style="margin-top: 15px;">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="nama_ayah" name="nama_ayah" placeholder="Isikan nama ayah..." value="<?= $detail->nama_ayah; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<input type="date" class="form-control" id="tanggal_lahir_ayah" name="tanggal_lahir_ayah" value="<?= $detail->tanggal_lahir_ayah; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group">
								<div class="form-group" style="margin-top: 15px;">
									<div class="form-group row" style="margin-left: 10px;">
										...
										<div class="col-sm-8">
											<div class="form-line focused">
												<input type="number" class="form-control" id="umur_ayah" name="umur_ayah" placeholder="masukkan umur ayah disini..." value="<?= $detail->umur_ayah; ?>">
												<i class=" fas fa-check-circle"></i>
												<i class="fas fa-exclamation-circle"></i>
												<small>Error massage</small>
											</div>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<input type="text" class="form-control" id="no_kk" name="no_kk" value="<?= $detail->no_kk; ?>" placeholder="masukkan NO KK disini...">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<input type="text" class="form-control" id="no_ktp" name="no_ktp" value="<?= $detail->no_ktp; ?>" placeholder="masukkan NO KTP disini...">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group" style="margin-top: 15px;">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="nama_pemohon" name="nama_pemohon" placeholder="Nama Pemohon" value="<?= $detail->nama_pemohon; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
							...
							<div class="form-group" style="margin-top: 15px;">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="hubungan_dengan_bayi" name="hubungan_dengan_bayi" placeholder="Isikan hubungan pemohon dengan bayi..." value="<?= $detail->hubungan_dengan_bayi; ?>">
											<i class=" fas fa-check-circle"></i>
											<i class="fas fa-exclamation-circle"></i>
											<small>Error massage</small>
										</div>
