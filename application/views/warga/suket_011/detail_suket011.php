                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" style="padding: 20px;">
                            ...
                            ?>
                                <img src="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $foto_kk->foto_kk; ?>" alt="foto kk" class="img-fluid">
                            <?php } ?>
                        </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" style="padding: 20px;">
                            ...
                            ?>
                                <img src="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $foto_surat_pindah->foto_surat_pindah; ?>" alt="foto surat pindah" class="img-fluid">
                            <?php } ?>
                        </div>
                        ...
                        <div class="card-footer py-3">
                            ...
                            foreach ($detail_suket as $suket011) { ?>
                                <div class="form-group ml-2 mr-2">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <label class="custom-file-label" for="file-upload-ttd">pilih foto surat pindah...</label>
