						...
						<div class="row">
							...
							<div class="col-md-01">
								...
								<input type="text" class="form-control form-user-input" name="no_tupoksi"
									id="no_tupoksi" value="475" disabled> 
							...
							<div class="form-group">
								<input type="text" class="form-control form-user-input" name="no_keterangan"
									id="no_keterangan" value="PEM" disabled>
									<small>Error Message</small>
							</div>
							</div>
							<h3>/</h3>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control form-user-input" name="nomor_surat_admin"
									id="nomor_surat_admin" value="<?= $detail->no_tupoksi; ?>/<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_kecamatan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_keterangan; ?>/<?= $detail->no_tahun; ?>" 
