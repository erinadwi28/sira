...
<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-3 mb-2">
						<input type="date" class="form-control form-user-input" name="tanggal_mulai"
							value="<?= $tgl_awal ?>" id="tanggal_mulai">
					</div>
					<div class="col-md-2 mt-2">
					...
					<div class="col-md-3 mb-2">
						<input type="date" class="form-control form-user-input" value="<?= $tgl_akhir ?>"
	...
	<div class="card shadow mb-4">
		<div class="card-header">
			<span>
				<a href="<?= base_url() ?>admin/cetak_laporan_riwayat_permohonan/<?= $tgl_awal ?>/<?= $tgl_akhir ?>">
				...
				<table class="table table-bordered table-hover" id="dataTable" width="100%"
					...
					<tbody>
						...
						<tr>
							...
							<?php if ($permohonan->status == "Ditolak Ketua RT" || $permohonan->status == "Ditolak Kelurahan") { ?>
