		...
		<div class="col-md-12 mb-4">
			...
			<div class="card shadow mb-4">
				<div class="card-body">
					...
					<form role="form" action="<?= base_url('kades/aksi_tambah_admin') ?>" method="post" id="formUbah">
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" name="nip" id="nip">
								</div>
								<div class="form-group">
									<label class="label-control" for="nik"><b>Jabatan</b></label>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<label class="label-control" for="no_kk"><b>No Kartu Keluarga</b></label>
								...
								<div class="form-group">
									...
									kata sandi
									<br />
									<input type="hidden" class="form-control form-user-input" name="status_kepegawaian" id="status_kepegawaian" value="Aktif">
								</div>
							</div>
						</div>
						<br>
