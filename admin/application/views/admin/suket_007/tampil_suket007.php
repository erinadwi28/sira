						...
						<div class="col-md-8">
							<div class="card shadow mb-4">
											...
											<div class="badan_surat">
												...
												<div class="isi_surat paragraf">
													<p> Yang bertanda tangan dibawah ini, Lurah Mendawai, Kecamatan Arut
														...
														Provinsi Kalimantan Tengah, Berdasarkan surat pengantar RT. <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?>
														Nomor : <?= $w->nomor_surat_rt; ?> tanggal <?php foreach ($detail_suket as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?>, Dengan ini menerangkan bahwa :</p>
												</div>
												...
												<div class="isi_surat paragraf">
													<p>
														Memang benar adalah Keluarga yang Tidak Mampu, adapun Surat Keterangan ini dipergunakan untuk <b><?= $w->keperluan; ?></b>.
													</p>
													<p>
								...
								<div class="card-footer">
									<center>
										<a href="<?= base_url() ?>admin/cetak_surat007/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
