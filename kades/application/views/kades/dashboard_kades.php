...
<div class="container-fluid">
	...
	<div class="align-items-center justify-content-between mb-4">
		<center>
			<h1 class="h3 mb-0 text-gray-800">Halaman Utama Kepala Desa</h1>
		</center>
	</div> 
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-0">
							<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
								Data Admin</div>
							<?php 
							foreach($jumlah_admin as $admin){ ?>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?= $admin->total_admin; ?></div>
							<?php } ?>
						</div>
						<div class="col-auto">
