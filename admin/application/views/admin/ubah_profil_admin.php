						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" name="nik" id="nik" value="34040071206890001" disabled>
								</div>

								<div class="form-group">
									<label class="label-control" for="nama"><b>Nama Lengkap</b></label>
									<input type="text" class="form-control form-user-input" name="nama" id="nama" value="Ahmad Syaebani" disabled>
								</div>
								<div class="form-group">
									<label class="label-control" for="nama"><b>Jabatan</b></label>
									<input type="text" class="form-control form-user-input" name="jabatan" id="jabatan" value="Staf Kel Mendawai" disabled>
								</div>
								<div class="form-group">
									<label class="label-control" for="tempat_lahir"><b>Tempat
											Lahir</b></label>
									<input type="text" class="form-control form-user-input" value="Sleman" name="tempat_lahir" id="tempat_lahir" disabled>
								</div>
								<div class="form-group">
									<label class="label-control" for="tanggal_lahir"><b>Tanggal
											Lahir</b></label>
									<input type="date" class="form-control form-user-input" value="2000-08-28" name="tanggal_lahir" id="tanggal_lahir" disabled>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="label-control" for="goldar"><b>Golongan
											Darah</b></label>
									<select class="form-control form-user-input" name="goldar" id="goldar" disabled>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" value="Rt 03 Kel.Mendawai" name="alamat" id="alamat" disabled>
								</div>
								<div class="form-group">
									<label class="label-control" for="rt"><b>RT</b></label>
									<input type="text" class="form-control form-user-input" value="003" name="rt" id="rt" disabled>
								</div>
								<div class="form-group">
									<label class="label-control" for="kelurahan"><b>Kelurahan</b></label>
									<input type="text" class="form-control form-user-input" value="Mendawai" name="kelurahan" id="kelurahan" disabled>
								</div>
								<div class="form-group">
									<label class="label-control" for="kecamatan"><b>Kecamatan</b></label>
									<input type="text" class="form-control form-user-input" value="Arut Selatan" name="kecamatan" id="kecamatan" disabled>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input type="text" class="form-control form-user-input" value="Pelajar/Mahasiswa" name="pekerjaan" id="pekerjaan" disabled>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" value="340429377111" name="no_kk" id="no_kk" disabled>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
								...
								<div class="form-group">
									<label class="label-control" for="status_hub_keluarga"><b>Status Hub
											Keluarga</b></label>
									<select class="form-control form-user-input" name="status_hub_keluarga" id="status_hub_keluarga" disabled>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" value="085713609299" name="no_hp" id="no_hp" disabled>
								</div>
								<div class="form-group">
