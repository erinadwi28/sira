						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" name="nama" id="nama"
										value="Ahmad Syaebani">
								</div>
								<div class="form-group">
									<label class="label-control" for="nama"><b>Jabatan</b></label>
									<input type="text" class="form-control form-user-input" name="jabatan" id="jabatan"
										value="Staf Kel Mendawai">
								</div>
								<div class="form-group">
									<label class="label-control" for="tempat_lahir"><b>Tempat
											Lahir</b></label>
									<input type="text" class="form-control form-user-input" value="Sleman"
										name="tempat_lahir" id="tempat_lahir">
								</div>
								<div class="form-group">
									<label class="label-control" for="tanggal_lahir"><b>Tanggal
											Lahir</b></label>
									<input type="date" class="form-control form-user-input" value="2000-08-28"
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" value="Rt 03 Kel.Mendawai"
										name="alamat" id="alamat">
								</div>
								<div class="form-group">
									<label class="label-control" for="rt"><b>RT</b></label>
									<input type="text" class="form-control form-user-input" value="003" name="rt"
										id="rt">
								</div>
								<div class="form-group">
									<label class="label-control" for="kelurahan"><b>Kelurahan</b></label>
									<input type="text" class="form-control form-user-input" value="Mendawai"
										name="kelurahan" id="kelurahan">
								</div>
								<div class="form-group">
									<label class="label-control" for="kecamatan"><b>Kecamatan</b></label>
									<input type="text" class="form-control form-user-input" value="Arut Selatan"
								...
								<div class="form-group">
									<input type="text" class="form-control form-user-input" value="Pelajar/Mahasiswa"
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" value="340429377111"
										name="no_kk" id="no_kk">
								</div>
							</div>
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-user-input" value="085713609299"
										name="no_hp" id="no_hp">
								</div>
								<div class="form-group">
