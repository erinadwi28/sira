						...
						<div class="col-md-8">
							<div class="card shadow mb-4">
									...
									<center>
										...
										?>
											...
											<div class="badan_surat">
												...
												<div class="isi_surat paragraf">
													<p>
														Berdasarkan Surat Keterangan dari Ketua Rukun Tetangga ( RT ) <?= $warga['rt'] ?>
														Kelurahan Mendawai, tanggal<?php foreach ($detail_permohonan as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?>
													Nomor : <?= $w->nomor_surat_rt; ?>, bahwa yang bersangkutan
													memang benar penduduk RT. <?= $warga['rt'] ?> Kelurahan
								...
								<div class="card-footer">
									<center>
										<a href="<?= base_url() ?>warga/cetak_surat/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
