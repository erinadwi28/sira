			...
			<div class="card border-left-danger shadow h-100 p-0">
				<div class="card-body px-3 py-3 ">
					...
					<div class="row mt-3">
						<div class="col-md-12">
							<center>
								<a href="<?= base_url('warga/list_persetujuan_rt') ?>"
									class="badge badge-danger">Selengkapnya <i class="fas fa-arrow-right"></i></a>
							</center>
						</div>
					</div>
				...
				<div class="card-body px-3 py-3 ">
					<div class="row no-gutters align-items-center">
						<div class="col mr-0">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?= $admin->total_persetujuan_admin; ?></div>
							<?php } ?>
						</div>
						<div class="col-auto">
					...
					<div class="row mt-3">
						<div class="col-md-12">
							<center>
								<a href="<?= base_url('warga/list_persetujuan_admin') ?>"
									class="badge badge-warning">Selengkapnya <i class="fas fa-arrow-right"></i></a>
							</center>
						</div>
					</div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body  px-3 py-3 ">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket004/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body  px-3 py-3 ">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket005/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body  px-3 py-3 ">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket006/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket007/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket008/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket009/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket010/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket011/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket012/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket013/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-primary shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <a class="btn btn-primary far fa-edit btn-sm" href="<?= base_url() ?>warga/form_suket014/<?= $warga['id_warga'] ?>" role="button"> Buat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-success shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div>
                            <button class="btn btn-success btn-sm"><i class="fa fa-download" aria-hidden="true"> Unduh</i></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-md-3 mb-3">
            <div class="card border-left-success shadow h-100 py-1">
                <div class="card-body px-3 py-3">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h6 mb-0 font-weight-bold text-success ">SUKET. REKOMENDASI USAHA MIKRO KECIL</div>
