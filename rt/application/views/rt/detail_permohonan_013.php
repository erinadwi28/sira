	...
	<div class="row">
		...
		<div class="col-md-8 mb-4">
			...
			<div class="card shadow mb-4">
				<div class="card-body">
					<form role="form" action="<?= base_url('rt/aksi_setujui_permohonan_013') ?>" method="post" id="suket013">
			...
			<div class="card shadow mb-2">
				<div class="card-body">
					<?php if($detail->no_registrasi != null && $detail->no_kelurahan  != null && $detail->no_bulan != null && $detail->no_tahun != null ) { ?>
					<form action="">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control form-user-input" name="nomor_surat_admin"
									...
									value="<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_tahun; ?>"
