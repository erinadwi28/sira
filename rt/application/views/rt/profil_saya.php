			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 20px;">
					...
					foreach ($foto_profil as $saya) { ?>
						<a href="<?= base_url(); ?>../assets/uploads/rt/<?= $saya->foto_profil_rt; ?>" data-lightbox="mygallery" data-title="Foto Profil">
							<img id="foto_profil_rt" src="<?= base_url(); ?>../assets/uploads/rt/<?= $saya->foto_profil_rt; ?>" alt="foto profil" class="img-fluid">
						</a>
					<?php } ?>
				</div>
