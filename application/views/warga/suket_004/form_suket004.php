...
<div class="container-fluid">
	...
	<div class="row clearfix">
		...
		<div class="col-xs-12 col-sm-8">
			<div class="card">
				<div class="body">
					<form class="form-horizontal" id="form4" action="" method="">
						...
						<div class="form-group">
							<div class="form-group" style="margin-top: 20px;">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<input type="text" class="form-control" id="nama_benar" name="nama_benar" placeholder="Nama benar">
						...
						<div class="form-group">
							<div class="form-group" style="margin-top: 20px;">
								<div class="form-group row" style="margin-left: 10px;">
									<label for="Dokumen_benar" class="col-sm-3 col-form-label">Dokumen Benar</label>
									<div class="col-sm-8">
										<div class="form-line">
											<select class="form-control " id="dokumen_benar">
												<option>Pilih Dokumen Benar</option>
							...
							<div class="form-group">
								<div class="form-group" style="margin-top: 20px;">
									<div class="form-group row" style="margin-left: 10px;">
										<label for="Nama_benar" class="col-sm-3 col-form-label">Nama Salah</label>
										<div class="col-sm-8">
											<div class="form-line">
												<input type="text" class="form-control" id="nama_salah" name="nama_salah" placeholder="Nama salah">
												<i class="fas fa-check-circle"></i>
												<i class="fas fa-exclamation-circle"></i>
												<small>Error massage</small>
											</div>
							...
							<div class="form-group">
								<div class="form-group" style="margin-top: 20px;">
									<div class="form-group row" style="margin-left: 10px;">
										<label for="dokumen_salah" class="col-sm-3 col-form-label">Dokumen Salah</label>
										<div class="col-sm-8">
											<div class="form-line">
												<select class="form-control " id="dokumen_salah">
													<option>Pilih Dokumen Salah</option>
													<option value="KTP">KTP</option>
													<option value="SIM">SIM</option>
													<option value="AKTA">AKTA</option>
													<option value="IJAZAH">IJAZAH</option>
