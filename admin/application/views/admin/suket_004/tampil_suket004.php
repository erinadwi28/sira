				        ...
				        <div class="col-md-8">
				            <div class="card shadow mb-4">
				                    ...
				                    <center>
                                        ...
                                        ?>
				                            ...
				                            <div class="badan_surat">
				                                ...
				                                <div class="isi_surat paragraf">
				                                    <p>
				                                        Berdasarkan Surat Keterangan dari Pengurus Rukun Tetangga ( RT ) <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?> Kelurahan Mendawai, Tanggal <?php
				                ...
				                <div class="card-footer">
				                    <center>
				                        <a href="<?= base_url() ?>admin/cetak_surat004/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
