				...
				<?php if ($detail->status == "Menunggu Persetujuan Kelurahan") { ?>
					<div class="card shadow mb-2">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary text-center">SURAT KETERANGAN BEDA NAMA</h6>
						</div>
						<div class="card-body">
							<form role="form" action="<?= base_url('admin/aksi_setujui_permohonan_004') ?>" method="post" id="suket4">
								...
								<table class="table-hover table-responsive">
									<tbody>
										...
										<tr>
											...
											<td>:</td>
											<td> </td>
											<td><?= $detail->nama_salah; ?></td>
										</tr>
										<tr>
											<td><b>Dokumen Nama Benar</b></td>
											<td> </td>
											<td>:</td>
											<td> </td>
											<td><?= $detail->nama_dokumen_benar; ?></td>
										</tr>
										<tr>
											<td><b>Dokumen Nama Salah</b></td>
											<td> </td>
											<td>:</td>
											<td> </td>
											<td><?= $detail->nama_dokumen_salah; ?></td>
										</tr>
										<tr>
							...
							<form action="">
								...
								<?php } elseif ($detail->status == 'Selesai') { ?>
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control form-user-input" name="nomor_surat_admin" id="nomor_surat_admin" value="<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_kecamatan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_tahun; ?>" style="text-align: center;" disabled>
										</div>
