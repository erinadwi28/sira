				...
				<div class="card-body">
					<form>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="pengirim" name="pengirim" value="Bupati">
							</div>
						</div>
						<div class="form-group row">
							<label for="perihal" class="col-sm-3 col-form-label">Perihal</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="perihal" name="perihal" value="Himbauan">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<textarea class="form-control" id="isi_surat" name="isi_surat"
									rows="3">Langkah-Langkah Pencegahan Penyebaran Covid</textarea>
							</div>
						</div>
						<div class="form-group row">
