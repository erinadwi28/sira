			...
			<div class="col-md-8 mb-4">
				...
				<?php if ($detail->status == "Menunggu Persetujuan Ketua RT") { ?>
					<div class="card shadow mb-2">
						<div class="card-body">
							<form role="form" action="<?= base_url('rt/aksi_setujui_permohonan_005') ?>" method="post" id="suket005">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										<div class="form-group-surat">
											<div class="form-line">
												<input type="text" class="form-control form-user-input" name="nomor_surat_rt" id="nomor_surat_rt">
												<i class="fas fa-check-circle"></i>
												<i class="fas fa-exclamation-circle"></i>
												<small> Error Message </small>
											</div>
										</div>
										<input type="hidden" class="form-control form-user-input" name="status" id="status" value="Menunggu Persetujuan Kelurahan">
				...
				<?php } else { ?>
					<div class="card shadow mb-2">
						<div class="card-body">
							<?php if ($detail->no_tupoksi != null && $detail->no_registrasi != null && $detail->no_kelurahan  != null && $detail->no_kecamatan != null && $detail->no_bulan != null && $detail->no_tahun != null) { ?>
								<form action="">
									<div class="row">
										<div class="col-md-12">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control form-user-input" name="nomor_surat_admin" id="nomor_surat_admin" value="<?= $detail->no_tupoksi; ?>/<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_kecamatan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_tahun; ?>" style="text-align: center;" disabled>
										</div>
										<div class="col-md-3">
										</div>
									</div>
