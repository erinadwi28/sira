				...
				<div class="col-md-12 mb-3">
					...
					<div class="card shadow mb-3">
						<div class="card-body">
							...
							<form role="form" action="<?= base_url('admin/aksi_ubah_kata_sandi_kades') ?>" method="post"
								id="formUbahSandiKades">
								<div class="row">
									<div class="col-md-7">
										<div class="form-group-ubahSandi">
											<input type="password" placeholder="masukan kata sandi baru"
												...
												id="kata_sandi">
											<input type="checkbox" class="form-checkbox" /> lihat kata sandi
											<br />
