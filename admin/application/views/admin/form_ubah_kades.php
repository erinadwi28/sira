							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input type="date" class="form-control form-user-input" 
										name="tanggal_lahir" id="tanggal_lahir" value="<?= $detail->tanggal_lahir; ?>">
								</div>
								<div class="form-group">
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control form-user-input form-password" 
										name="kata_sandi" id="kata_sandi" value="<?= $detail->kata_sandi; ?>">
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control form-user-input " 
										name="status_kepegawaian" id="status_kepegawaian" value="<?= $detail->status_kepegawaian; ?>">
								</div>
