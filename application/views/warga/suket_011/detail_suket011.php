		...
		<div class="col-md-4 mb-4">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 15px;">
					...
					<center>
						<a href="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $pas_foto->pas_foto; ?>"
							data-gallery="mygallery" data-title="Foto KTP" data-toggle="lightbox">
							<img src="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $pas_foto->pas_foto; ?>"
								alt="pas foto" class="img-fluid" width="200px">
						</a>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 15px;">
					<?php
							...
							?>
					<center>
						<a href="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $foto_kk->foto_kk; ?>"
							data-gallery="mygallery" data-title="Foto KK" data-toggle="lightbox">
							<img src="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $foto_kk->foto_kk; ?>"
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 15px;">
					<?php
							...
							?>
					<center>
						<a href="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $foto_surat_pindah->foto_surat_pindah; ?>"
							data-gallery="mygallery" data-title="Foto Surat Pindah" data-toggle="lightbox">
							<img src="<?= base_url(); ?>/assets/uploads/warga/suket_011/<?= $foto_surat_pindah->foto_surat_pindah; ?>"
								alt="foto surat pindah" class="img-fluid" width="200px">
						</a>
					</center>
					<?php } ?>
				</div>
