						...
						<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<select class="form-control" id="agama">
												<option value="" class="form-user-input">Islam</option>
												<option value="" class="form-user-input">Protestan</option>
												<option value="" class="form-user-input">Katholik</option>
												<option value="" class="form-user-input">Hindu</option>
												<option value="" class="form-user-input">Budha</option>
												<option value="" class="form-user-input">Khonghucu</option>
											</select>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								<div class="form-group row" style="margin-left: 10px;">
									...
									<div class="col-sm-8">
										<div class="form-line">
											<input type="text" class="form-control" id="no_surat_pindah" name="no_surat_pindah" value="" required="">
										</div>
									</div>
								</div>
							</div>
