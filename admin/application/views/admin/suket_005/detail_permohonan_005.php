								...
								<div class="row">
									<div class="col-md-12">
										<center> <b><label for="nomor_surat_admin">Masukkan Nomor Surat Kelurahan Untuk
											...
											<em class="small text-danger">Format Nomor Surat : 300 / No.Registrasi / KM / AS /
												Bulan / Tahun</em>
										</center>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-0 ml-4">
										<div class="form-group">
											<input type="text" class="form-control form-user-input" name="no_tupoksi" id="no_tupoksi" value="300" disabled>
						...
						<center>
							<div class="mb-2">
								<a href="<?= base_url(); ?>../assets/uploads/warga/suket_005/<?= $detail->foto_ktp; ?>" data-gallery="mygallery" data-title="Foto KTP" data-toggle="lightbox">
									<img src="<?= base_url(); ?>../assets/uploads/warga/suket_005/<?= $detail->foto_ktp; ?>" alt="foto ktp" class="img-fluid" width="200px">
								</a>
							</div>
						</center>
					</div>
