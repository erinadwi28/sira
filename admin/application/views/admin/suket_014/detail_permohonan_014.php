			...
			<div class="col-md-10 mb-4">
				...
				<?php if ($detail->status == "Menunggu Persetujuan Kelurahan") { ?>
					<div class="card shadow mb-2">
						...
						<div class="card-body">
							<form role="form" action="<?= base_url('admin/aksi_setujui_permohonan_014') ?>" method="post" id="suket14">
								...
								<div class="row">
									<div class="col-md-12">
										<center> <b><label for="nomor_surat_admin">Masukkan Nomor Surat Kelurahan Untuk
											...
											<em class="small text-danger">Format Nomor Surat : 475 / No.Registrasi / KM / AS / Bulan / PEM / Tahun</em>
										</center>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-01">
										<div class="form-group">
											<input type="text" class="form-control form-user-input" name="no_tupoksi" id="no_tupoksi" value="475" disabled>
									...
									<div class="col-md-01">
										<div class="form-group">
											<input type="text" class="form-control form-user-input" name="no_kecamatan" id="no_kecamatan" value="AS" disabled>
											<small>Error Message</small>
										</div>
									</div>
									<h3>/</h3>
									...
									<div class="col-md-01">
										<div class="form-group">
											<input type="text" class="form-control form-user-input" name="no_keterangan" id="no_keterangan" value="PEM" disabled>
											<small>Error Message</small>
										</div>
									</div>
									<h3>/</h3>
							...
							<form action="">
								...
								<?php } elseif ($detail->status == 'Selesai') { ?>
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control form-user-input" name="nomor_surat_admin" id="nomor_surat_admin" value="<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_tahun; ?>" style="text-align: center;" disabled>
										</div>
