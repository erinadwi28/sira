...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="<?= base_url()?>admin/profil_saya/<?= $detail->id_admin ?>">
		...
		<div class="col-md-12 mb-4">
			...
			<div class="card shadow mb-4">
				<div class="card-body">
						...
						<form role="form" action="<?= base_url('admin/aksi_ubah_profil_saya') ?>" method="post" id="formUbah">
							<div class="row">
								<div class="col-md-4">
							...
							<input type="hidden" class="form-control form-user-input " name="id_admin" id="id_admin" value="<?= $detail->id_admin; ?>">
						</form>
					<?php } ?>
				</div>
			</div>
