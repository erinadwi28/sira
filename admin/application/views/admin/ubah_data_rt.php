...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ubah Data Ketua RT</h1>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-user-input" name="nik" id="nik" value="">
                                </div>

                                <div class="form-group">
                                    <label class="label-control" for="nama"><b>Nama Lengkap</b></label>
                                    <input type="text" class="form-control form-user-input" name="nama" id="nama" value="">
                                </div>
                                <div class="form-group">
                                    <label class="label-control" for="tempat_lahir"><b>Tempat
                                            Lahir</b></label>
                                    <input type="text" class="form-control form-user-input" value="" name="tempat_lahir" id="tempat_lahir">
                                </div>
                                <div class="form-group">
                                    <label class="label-control" for="tanggal_lahir"><b>Tanggal
                                            Lahir</b></label>
                                    <input type="date" class="form-control form-user-input" value="" name="tanggal_lahir" id="tanggal_lahir">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-user-input" value="" name="alamat" id="alamat">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="label-control" for="rt"><b>RT</b></label>
                                    <input type="text" class="form-control form-user-input" value="" name="rt" id="rt">
                                </div>
                                <div class="form-group">
                                    <label class="label-control" for="kelurahan"><b>Kelurahan</b></label>
                                    <input type="text" class="form-control form-user-input" value="" name="kelurahan" id="kelurahan">
                                </div>
                                <div class="form-group">
                                    <label class="label-control" for="kecamatan"><b>Kecamatan</b></label>
                                    <input type="text" class="form-control form-user-input" value="" name="kecamatan" id="kecamatan">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-user-input" value="" name="pekerjaan" id="pekerjaan">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-user-input" value="" name="no_kk" id="no_kk">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-user-input" value="" name="no_hp" id="no_hp">
                                </div>
                                <div class="form-group">
                                    <label class="label-control" for="kata_sandi"><b>Kata
                                            Sandi</b></label>
                                    <input type="password" class="form-control form-user-input form-password" value="" name="kata_sandi" id="kata_sandi">
                                ...
                                <input type="hidden" id="status_kepegawaian" name="" value="Aktive">
                            </div>
                        </div>
                    </form>
                </div>
