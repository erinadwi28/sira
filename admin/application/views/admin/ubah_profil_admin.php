										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control form-user-input"
														value="Rt 03 Kel.Mendawai" name="alamat" id="alamat">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control form-user-input"
														value="Mendawai" name="kelurahan" id="kelurahan">
												</div>
												<div class="form-group">
													<label class="label-control"
														for="kecamatan"><b>Kecamatan</b></label>
													<input type="text" class="form-control form-user-input"
														value="Arut Selatan" name="kecamatan" id="kecamatan">
												</div>
												<div class="form-group">
											...
											<div class="col-md-4">
												...
												<div class="form-group">
													<label class="label-control" for="status_hub_keluarga"><b>Status Hub
															Keluarga</b></label>
													<select class="form-control form-user-input"
														name="status_hub_keluarga" id="status_hub_keluarga">
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="custom-file">
															<input type="file" class="custom-file-input" id="foto_kk"
																name="foto_kk">
															<label class="custom-file-label upload-area"
																for="exampleInputFile">Pilih File...</label>
														</div>
