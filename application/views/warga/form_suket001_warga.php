		...
		<div class="col-xs-12 col-sm-8">
			<div class="card">
					...
					<form class="form-horizontal" id="form_suket001" action="" method="">
							...
							<div class="form-group">
								<div class="form-group" style="margin-top: 15px;">
									<div class="form-group row" style="margin-left: 10px;">
										...
										<div class="col-sm-8">
											<div class="form-line focused">
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" value="Rahma Maulani" required="">
						...
						<div class="form-group">
							<div class="form-group row" style="margin-left: 10px;">
								...
								<div class="col-sm-8">
									<div class="form-line">
										<textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Alamat Lengkap" required="Isikan Alamat"></textarea>
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="form-group" style="margin-top: 15px;">
								<div class="form-group row" style="margin-left: 10px;">
									<label for="u=Usaha" class="col-sm-3 col-form-label">Usaha</label>
									<div class="col-sm-8">
										<div class="form-line focused">
											<input type="text" class="form-control" id="usaha" name="usaha" placeholder="Usaha" value="" required="">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="card-footer">
					<div class="form-group">
						<div class=" col-sm-offset-0 col-sm-4" style="float: right;">
