				...
				<center>
					...
					<?php foreach ($foto_profil as $saya) { ?>
						<a href="<?= base_url(); ?>../assets/uploads/kades/<?= $saya->foto_profil_kades; ?>" data-gallery="mygallery" data-title="Foto Profil" data-toggle="lightbox">
							<img src="<?= base_url(); ?>../assets/uploads/kades/<?= $saya->foto_profil_kades; ?>" alt="foto profil" class="img-fluid">
						</a>
					<?php } ?>
						...
						<div class="form-group ml-2 mr-2">
							<div class="input-group">
								<div class="custom-file">
									...
									<input type="hidden" class="form-control form-user-input" name="id_kades" id="id_kades" value="<?= $saya->id_kades; ?>">
								</div>
							</div>
						</div>
					<?php } ?>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 20px;">
					<?php foreach ($foto_ktp as $saya) { ?>
						...
						<img src="<?= base_url(); ?>../assets/uploads/kades/<?= $saya->foto_ktp_kades; ?>" alt="foto profil" class="img-fluid">
						</a>
					<?php } ?>
				</div>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 20px;">
					...
					?>
						...
						<img src="<?= base_url(); ?>../assets/uploads/kades/<?= $saya->foto_kk_kades; ?>" alt="foto kk" class="img-fluid">
						</a>
					<?php } ?>
				</div>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-footer">
					<div class="float-right">
						<a href="<?= base_url() ?>kades/form_ubah_profil_saya/<?= $detail->id_kades ?>">
