                         ...
                         <div class="row">
                             <div class="col-md-4">
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control form-user-input" name="nik" id="nik" value="123456789">
                                 </div>

                                 <div class="form-group">
                                     <label class="label-control" for="nama"><b>Nama Lengkap</b></label>
                                     <input type="text" class="form-control form-user-input" name="nama" id="nama" value="Erina Dwi Utami">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="tempat_lahir"><b>Tempat
                                             Lahir</b></label>
                                     <input type="text" class="form-control form-user-input" value="Sleman" name="tempat_lahir" id="tempat_lahir">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="tanggal_lahir"><b>Tanggal
                                             Lahir</b></label>
                                     <input type="date" class="form-control form-user-input" value="2000-08-28" name="tanggal_lahir" id="tanggal_lahir">
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                     <label class="label-control" for="goldar"><b>Golongan
                                             Darah</b></label>
                                     <select class="form-control form-user-input" name="goldar" id="goldar">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control form-user-input" value="Mudal" name="alamat" id="alamat">
                                 </div>
                             </div>
                             <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control form-user-input" value="005" name="rt" id="rt">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="kelurahan"><b>Kelurahan</b></label>
                                     <input type="text" class="form-control form-user-input" value="Argomulyo" name="kelurahan" id="kelurahan">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="kecamatan"><b>Kecamatan</b></label>
                                     <input type="text" class="form-control form-user-input" value="Cangkringan" name="kecamatan" id="kecamatan">
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                     <input type="text" class="form-control form-user-input" value="Pelajar/Mahasiswa" name="pekerjaan" id="pekerjaan">
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                     <label class="label-control" for="status_hub_keluarga"><b>Status Hub
                                             Keluarga</b></label>
                                     <select class="form-control form-user-input" name="status_hub_keluarga" id="status_hub_keluarga">
                                 ...
                                 <div class="form-group">
                                     <label class="label-control" for="foto_profil"><b>Foto KTP</b></label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control form-user-input" value="340429377111" name="no_kk" id="no_kk">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="foto_profil"><b>Foto KK</b></label>
                                     <div class="input-group">
                                         <div class="custom-file">
                                             <input type="file" class="custom-file-input" id="foto_profil" name="foto_profil">
                                             <label class="custom-file-label upload-area" for="exampleInputFile">Pilih File...</label>
                                 ...
                                 <div class="form-group">
                                     <label class="label-control" for="status_kepegawaian"><b>Status Kepegawaian</b></label>
                                     <input type="text" class="form-control form-user-input" value="Kepala Desa" name="status_kepegawaian" id="status_kepegawaian">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="no_hp"><b>No HandPhone</b></label>
                                     <input type="text" class="form-control form-user-input" value="085713609299" name="no_hp" id="no_hp">
                                 </div>
                                 <div class="form-group">
                                     <label class="label-control" for="kata_sandi"><b>Kata
                                             Sandi</b></label>
                                     <input type="password" class="form-control form-user-input form-password" value="erinadwi" name="kata_sandi" id="kata_sandi">
