						...
						<div class="card-body">
							<form role="form" action="<?= base_url('admin/aksi_setujui_permohonan_001') ?>" method="post" id="suket1">
								...
								<div class="row">
									...
									<div class="col-md-01">
										<div class="form-group">
											<input type="text" class="form-control form-user-input" name="no_keterangan" id="no_keterangan" value="Um" disabled>
											<small>Error Message</small>
										</div>
									</div>
								</div>
								...
								<div class="float-right ml-2">
									<a href="">
										<button id="btn_simpan" type="submit" class="btn btn-sm btn-success">
							...
							<form action="">
								...
								<?php } elseif ($detail->status == 'Selesai') { ?>
									<div class="row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control form-user-input" name="nomor_surat_admin" id="nomor_surat_admin" value="<?= $detail->no_registrasi; ?>/<?= $detail->no_kelurahan; ?>/<?= $detail->no_kecamatan; ?>/<?= $detail->no_bulan; ?>/<?= $detail->no_tahun; ?>/<?= $detail->no_keterangan; ?>" style="text-align: center;" disabled>
										</div>
