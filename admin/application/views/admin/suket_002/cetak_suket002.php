                        ...
                        <center>
                            ...
                            ?>
                                ...
                                <div class="badan_surat">
                                    ...
                                    <div class="isi_surat paragraf">
                                        <p>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan Surat Keterangan dari Ketua Rukun Tetangga ( RT ) <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?> Kelurahan Mendawai, Nomor :
                                            <?= $w->nomor_surat_rt; ?> tanggal <?php foreach ($detail_suket as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?>,
                                                bahwa nama tersebut diatas memang benar Berdomisili di RT. <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?> Kelurahan Mendawai Kecamatan Arut Selatan Kabupaten Kotawaringin Barat.
                                        </p>
                                        <p>
