...
const formtambahpejabatberwenang = document.getElementById("formTambahPejabatBerwenang")
...
const pangkat_gol = document.getElementById("pangkat_gol");
...
if (formtambah != null) {
...
} else if (formtambahpejabatberwenang != null) {
	formtambahpejabatberwenang.addEventListener("submit", (e) => {
		if (checkInputs4() == true) {
			e.target.submit();
		} else
			e.preventDefault();
	});
	...
	function checkInputs() {
		...
		if (nipValue === "") {
			setErrorFor(nip, "Nik tidak boleh kosong");
			return (false);
		} else {
			setSuccessFor(nip);
		}
	...
	function checkInputs4() {
		const nipValue = nip.value.trim();
		const namaValue = nama.value.trim();
		const jabatanValue = jabatan.value.trim();
		const pangkat_golValue = pangkat_gol.value.trim();
		

		if (nipValue === "") {
			setErrorFor(nip, "UYY tidak boleh kosong");
			return (false);
		} else {
			setSuccessFor(nip);
		}
		...
		if (jabatanValue === "") {
			setErrorFor(jabatan, "Jabatan tidak boleh kosong");
			return (false);
		} else {
			setSuccessFor(jabatan);
		}
		if (pangkat_golValue === "") {
			setErrorFor(pangkat_gol, "Pangkat/Golongan tidak boleh kosong");
			return (false);
		} else {
			setSuccessFor(pangkat_gol);
		}
