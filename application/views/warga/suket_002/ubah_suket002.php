...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Ubah Permohonan Surat Keterangan Domisili</h1>
        <?php
        foreach ($detail_suket as $detail) {

        ?>
            <a href="<?= base_url('warga/detail_suket002/' . $detail->id_surat . '/' . $detail->id_permohonan_surat) ?>">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="card shadow mb-5">
                <div class="body">
                    ...
                    <form class="form-horizontal" id="form_ubah_suket002" action="<?= base_url('warga/aksi_ubah_suket002') ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="form-group row" style="margin-left: 10px;">
                            ...
                            <div class="col-sm-8">
                                <div class="form-line">
                                    <textarea class="form-control" id="alamat_kk" name="alamat_kk" rows="3"><?= $detail->alamat_kk ?></textarea>
                                    <i class=" fas fa-check-circle"></i>
                                    <i class="fas fa-exclamation-circle"></i>
                                    <small>Error massage</small>
                                </div>
