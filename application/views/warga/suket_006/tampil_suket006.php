						...
						<div class="col-md-8">
							<div class="card shadow mb-4">
											...
											<div class="badan_surat">
												...
												<div class="isi_surat paragraf">
													<p>
														...
														tanggal <?php foreach ($detail_permohonan as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?> , Nomor : <?= $w->nomor_surat_rt; ?>,
								...
								<div class="card-footer">
									<center>
										<a href="<?= base_url() ?>warga/cetak_surat006/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
