				        ...
				        <div class="col-md-8">
				            <div class="card shadow mb-4">
				                    ...
				                    <center>
                                        ...
                                        ?>
				                            ...
				                            <div class="badan_surat">
				                                ...
				                                <div class="isi_surat paragraf">
				                                    <p>
				                                        Berdasarkan Surat Keterangan dari Ketua Rukun Tetangga ( RT ) <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?> Kelurahan Mendawai, Nomor : <?= $w->nomor_surat_rt; ?> tanggal <?php foreach ($detail_suket as $d) { ?> <?= format_indo(date($d->tanggal_persetujuan_rt)); ?> <?php } ?>, bahwa nama tersebut diatas memang benar Berdomisili di RT. <?php foreach ($detail_pemohon as $d) { ?> <?= $d->rt; ?> <?php } ?> Kelurahan Mendawai Kecamatan Arut Selatan Kabupaten Kotawaringin Barat. </p>
				                                    <p>
				                ...
				                <div class="card-footer">
				                    <center>
				                        <a href="<?= base_url() ?>admin/cetak_surat002/<?php foreach ($detail_suket as $w) { ?><?= $w->id_permohonan_surat ?> <?php } ?>">
