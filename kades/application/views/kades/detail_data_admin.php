		...
		<div class="col-md-4 mb-4">
			...
			<div class="card shadow mb-4">
                ...
                <center>
					...
					foreach ($foto_profil as $admin) { ?>
						<img src="<?= base_url(); ?>../assets/uploads/admin/<?= $admin->foto_profil_admin; ?>" alt="foto profil" class="img-fluid">
					<?php } ?>
                </center>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 20px;">
					...
					?>
						<img src="<?= base_url(); ?>../assets/uploads/admin/<?= $admin->foto_ktp_admin; ?>" alt="foto profil" class="img-fluid">
					<?php } ?>
				</div>
			</div>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body" style="padding: 20px;">
					...
					?>
						<img src="<?= base_url(); ?>../assets/uploads/admin/<?= $admin->foto_kk_admin; ?>" alt="foto kk" class="img-fluid">
					<?php } ?>
				</div>
			</div>
		</div>
