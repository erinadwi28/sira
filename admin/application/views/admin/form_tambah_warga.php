		...
		<div class="col-md-12 mb-4">
			...
			<div class="card shadow mb-4">
				<div class="card-body">
					...
					<?= form_open_multipart('admin/aksi_tambah_warga') ?>
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<select class="form-control form-user-input" name="golongan_darah" id="golongan_darah">
										<option class="form-user-input" selected>pilih golongan darah...
										</option>
								...
								<div class="form-group">
									...
									<select class="form-control form-user-input" name="agama" id="agama">
										<option class="form-user-input" selected>pilih agama...
										</option>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<select class="form-control form-user-input" name="kewarganegaraan"	id="kewarganegaraan">
										<option class="form-user-input" selected>pilih kewarganegaraan...
										</option>
								...
								<div class="form-group">
									...
									<select class="form-control form-user-input" name="pendidikan_terakhir"
										...
										<option value="" class="form-user-input" selected>pilih pendidikan terakhir...
										</option>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control form-user-input" name="status_hub_kel"
										id="status_hub_kel">
										<option value="" class="form-user-input" selected>pilih status hubungan
											keluarga...
										</option>
