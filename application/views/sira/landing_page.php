				...
				<div class="col-lg-12">
					<div class="contact-text section-header text-center">
						<div>
							...
							<div class="desc-text">
								<p>
									Jika Anda mendapati masalah dalam penggunaan aplikasi ini.
									Anda dapat menghubungi kami agar segera kami tangani.
								</p>
								<p>
									atau Anda juga boleh untuk meninggalkan kesan dan pesan agar
				...
				<div class="col-lg-6 col-md-12">
					<form id="contactForm" action="<?= base_url('landing_page/aksi_tambah_feedback') ?>" method="POST">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<textarea class="form-control-input" id="isi" name="isi" rows="4"
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="widget">
							...
							<p><i class="lni-mobile"></i> 085713609299</p>
							<p><i class="lni-comment-alt"></i> kelurahan@gmail.com</p>
