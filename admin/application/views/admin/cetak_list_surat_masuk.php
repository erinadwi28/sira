...
<head>
    ...
    <title>Laporan Surat Masuk Kedinasan Kelurahan Mendawai(Periode &nbsp;<?= format_indo(date($tgl_awal)); ?>&nbsp;-&nbsp;<?= format_indo(date($tgl_akhir)); ?>)</title>
    <!--Tittle Icon-->
...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <center>
                <h2 class="h3 mb-0 text-gray-800">Laporan Surat Masuk Kedinasan Kelurahan Mendawai</h2><br>
