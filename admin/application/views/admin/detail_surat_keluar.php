	...
	<div class="row">
		<div class="col-md-4 mb-4">
			...
			<div class="card shadow mb-4">
				...
				<form action="<?= base_url('admin/upload_lampiran_surat_keluar') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_surat_masuk_admin">
						...
						<div class="input-group">
							...
							<div class="custom-file">
								...
								<input type="hidden" class="form-control form-user-input" name="id_sk" id="id_sk" value="<?= $sk->id_sk ?>">
