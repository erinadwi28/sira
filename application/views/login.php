...
<head>
	...
	<link href="<?= base_url('assets/dashboard/') ?>css/validation_login_warga.css" rel="stylesheet" />
</head>
...
<body class="bg-gradient-primary">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form action="<?= base_url('login/aksi_login'); ?>" method="post" id="formLoginWarga">
	...
	<script src="<?= base_url('assets/dashboard/') ?>js/validation_login_warga.js"></script>
