...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Ubah Profile Saya</h1>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control form-user-input"
                                                        value="" name="tanggal_lahir" id="tanggal_lahir">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-user-input" name="agama"
                                                        id="goldar">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-user-input"
                                                        value="Kiyudan" name="alamat" id="alamat">
                                                </div>
                                                <div class="form-group">
                                                    <label class="label-control" for="rt"><b>RT</b></label>
                                                    <input type="text" class="form-control form-user-input" value="003"
                                                        name="rt" id="rt">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-user-input"
                                                        value="Selomartani" name="kelurahan" id="kelurahan">
                                                </div>
                                                <div class="form-group">
                                                    <label class="label-control"
                                                        for="kecamatan"><b>Kecamatan</b></label>
                                                    <input type="text" class="form-control form-user-input"
                                                        value="Kalasan" name="kecamatan" id="kecamatan">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-user-input"
                                                        value="3404101102054625" name="no_kk" id="no_kk">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-user-input"
                                                        value="085712166795" name="no_hp" id="no_hp">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        value="rahmau" name="kata_sandi" id="kata_sandi">
